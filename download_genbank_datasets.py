...
def download_genbank(name, genome_path, outF, protein, rna):
...
def download_genomes(csv, outdir, ipfs=False, genbank=False, protein=False, rna=False):
    ...
    with open (failedF, 'w') as failed:
        for g in genomes:
            ...
            if ipfs:
                ...
                download_genbank(out_name, g, out, protein, rna)
...
if __name__ == '__main__':
    ...
    args = psr.parse_args()
    download_genomes(args.csv, args.outdir, args.ipfs, args.genbank, args.protein, args.rna)
